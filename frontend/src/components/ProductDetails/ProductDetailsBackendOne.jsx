...
const ProductDetailsBackendOne = () => {
    ...
    return (
        <div className="pdb1-page">
            <button className="pdb1-back-btn" onClick={() => navigate(`/products/${category_slug}/${subcategory_slug}`)}>
            ...
            <div className="pdb1-container">
                ...
                <aside className="pdb1-sidebar">
                    ...
                    <div className="pdb1-card">
                        <button className="pdb1-action-btn primary" onClick={() => navigate(`/contact?product=${product.slug}`)}>Request Quote</button>
